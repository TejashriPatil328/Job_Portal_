                                ...
                                <Popover>
                                    ...
                                    <PopoverContent variant="outline" className='w-80 m-2 border border-gray-150 p-2'>
                                        <div className='flex gap-4 space-y-2 p-2'>
                                            ...
                                            <div>
                                                <h4 className='font-medium'>Patil Kalpesh</h4>
                                                <p className='text-sm text-muted-foreground'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error earum qui, </p>
                                            </div>
                                        </div>
                                        <div className='flex flex-col my-2 text-gray-600'>
                                            ...
                                            <div className='flex w-fit items-center gap-2 cursor-pointer'>
                                                <LogOut />
                                                <Button variant='link' className='border-0'>Logout</Button>
                                            </div>
                                        </div>
                                    </PopoverContent>
                                </Popover>
